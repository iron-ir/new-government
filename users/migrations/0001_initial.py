...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='religion',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bi_c_religion', to='base_information_settings.baseinformation', verbose_name='دین'),
        ),
        migrations.AddField(
            model_name='user',
