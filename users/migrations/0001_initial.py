...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('base_information_setting', '__first__'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_avatar_verify', models.BooleanField(default=False, verbose_name='تایید عکس پروفایل')),
                ('first_name', models.CharField(blank=True, max_length=64, null=True, verbose_name='نام')),
                ('is_first_name_verify', models.BooleanField(default=False, verbose_name='تایید نام')),
                ('last_name', models.CharField(blank=True, max_length=64, null=True, verbose_name='نام خانوادگی')),
                ('is_last_name_verify', models.BooleanField(default=False, verbose_name='تایید نام خانوادگی')),
                ('_gender', models.CharField(choices=[('0', 'خالی'), ('1', 'خانوم'), ('2', 'آقا'), ('3', 'دیگر')], default='0', max_length=1, verbose_name='جنسیت')),
                ('is_gendre_verify', models.BooleanField(default=False, verbose_name='تایید جنسیت')),
                ...
                ('is_national_code_verify', models.BooleanField(default=False, verbose_name='تایید شماره ملی')),
                ('father_name', models.CharField(blank=True, max_length=32, null=True, verbose_name='نام پدر')),
                ('is_father_name_verify', models.BooleanField(default=False, verbose_name='تایید عکس پروفایل')),
                ('mother_name', models.CharField(blank=True, max_length=32, null=True, verbose_name='نام مادر')),
                ('is_mother_name_verify', models.BooleanField(default=False, verbose_name='تایید عکس پروفایل')),
                ('birth_date', models.DateField(blank=True, null=True, verbose_name='تاریخ تولد')),
                ('is_birth_date_verify', models.BooleanField(default=False, verbose_name='تایید تاریخ تولد')),
                ('is_birth_place_verify', models.BooleanField(default=False, verbose_name='تایید محل تولد')),
                ('is_nationality_verify', models.BooleanField(default=False, verbose_name='تایید ملیت')),
                ('is_religion_verify', models.BooleanField(default=False, verbose_name='تایید دین')),
                ('official_website', models.URLField(blank=True, null=True, unique=True, verbose_name='وب سایت رسمی')),
                ('is_official_website_verify', models.BooleanField(default=False, verbose_name='تایید وب سایت رسمی')),
